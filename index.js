...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.blowuoi.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const database = client.db("MildlifeJourney");
...
app.get("/", (req, res) => {
  res.send("Running The  Mildlife Journey Server");
});
